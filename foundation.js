function listing() {
    ...
    if (url != url2) {
        ...
        // select third type
        document.getElementsByTagName('section')[0].children[0].children[1].children[1].children[1].children[0].children[2].children[1].children[3].click();
        // select fourt type
        ...
        document.getElementById('fieldOptions').children[1].click();
        // free size
        ...
        document.getElementById('fieldOptions').children[51].click();
        // select finish
        ...
        document.getElementById('fieldOptions').children[3].click();
        // select country
        ...
        document.getElementById('fieldOptions').children[15].click();
        // save catalog
